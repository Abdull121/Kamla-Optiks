...
if ($method === 'GET') {
    ...
    if (strpos($contentType, 'application/json') !== false) {
        ...
        try {
            $stmt = $pdo->prepare("INSERT INTO products (name, category_id, brand_id, price, discount_price, stock_quantity, delivery_charges, description, image, in_stock) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
            $stmt->execute([$name, $category_id, $brand_id, $price, $discount_price, $stock_quantity, $delivery_charges, $description, $image, $in_stock]);
        ...
        try {
            $stmt = $pdo->prepare("INSERT INTO products (name, category_id, brand_id, price, discount_price, stock_quantity, delivery_charges, description, image, in_stock) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
            $stmt->execute([$name, $category_id, $brand_id, $price, $discount_price, $stock_quantity, $delivery_charges, $description, $imagePath, $in_stock]);
    ...
    try {
        $stmt = $pdo->prepare("UPDATE products SET name=?, category_id=?, brand_id=?, price=?, discount_price=?, stock_quantity=?, delivery_charges=?, description=?, image=?, in_stock=? WHERE id=?");
        $stmt->execute([$name, $category_id, $brand_id, $price, $discount_price, $stock_quantity, $delivery_charges, $description, $image, $in_stock, $id]);
